...
public class log2 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println(preTituloHTML5+"<title>Log</title></head><body>");
		...
		boolean saved = escribirLog(request.getParameter("usuario"),request.getRemoteAddr(),"log2",request.getMethod());				
